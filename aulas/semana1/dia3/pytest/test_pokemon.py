import json
import pytest
from pokemon import retrieve_pokemons_by_type, retrieve_pokemons_by_type_open
...
def test_retrieve_pokemons_by_types(grass_type_pokemon, water_type_pokemon):
    fake_file = StringIO(
...
def test_retrieve_pokemons_by_type():
    ...
    with patch("builtins.open", mock_open(read_data=pokemon_json_content)):
        assert retrieve_pokemons_by_type_open("Grass", "dummy") == [
            grass_type_pokemon
        ]